...
local saveFile = "WataX_Key_ckptw.txt"
...
local function isKeyValid(k)
    local url = "https://raw.githubusercontent.com/WataXScript/WataXMountCkptw/main/Loader/eldl/"..k
...
if lastKey and isKeyValid(lastKey) then
    ...
    mainFrame.Visible = false
    loadstring(game:HttpGet("https://raw.githubusercontent.com/WataXScript/WataXMountCkptw/main/Loader/WataX.lua"))()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/WataXScript/WataXMountCkptw/main/Loader/mainmap691.lua"))()
end
